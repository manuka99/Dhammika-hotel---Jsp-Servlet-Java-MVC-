      ...
      <ul class="custom-scrollbar">
        ...
        <li>
          <ul class="collapsible collapsible-accordion">
            ...
            <li>
              <a class="collapsible-header waves-effect arrow-r">
                <i class="w-fa fab fa-css3"></i>Categories<i class="fas fa-angle-down rotate-icon"></i>
              </a>
              <div class="collapsible-body" id="panelCategory">
              
                <ul>
                                <c:forEach var="category" items="${CategoryList}">
                  <li>
                    <a href="../css/grid.html" class="waves-effect">${category.name}</a>
                  </li>   
                  </c:forEach>
    ...
    <nav class="navbar fixed-top navbar-expand-lg scrolling-navbar double-nav">
      ...
      <div class="d-flex change-mode">
        ...
        <div class="ml-auto mb-0 mr-3 change-mode-wrapper">
          <button class="btn btn-outline-black btn-sm waves-effect waves-light" id="dark-mode">Change Mode</button>
        </div>
