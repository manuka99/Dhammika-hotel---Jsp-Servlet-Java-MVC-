						...
						<div id="dataTableFood">
							...
							<div class="card card-cascade narrower">
								...
								<div
									...
									<a href="" class="white-text mx-3">Inquiry Management</a>



									<div>
										<button type="button" onclick="respondInquiries()"
											class="btn btn-outline-white btn-rounded btn-sm px-2">
											<i class="fas fa-pencil-alt mt-0"></i>
										</button>
										<button type="button" onclick="deleteInquiries()"
											class="btn btn-outline-white btn-rounded btn-sm px-2">
													...
													<c:forEach var="Inquiry" items="${InquiryDBList}">
														<tr>
															<th scope="row"><input class="form-check-input"
																type="checkbox" id="${Inquiry.inquiryID}"
																value="${Inquiry.inquiryID}" name="items"> <label
																class="form-check-label" for="${Inquiry.inquiryID}"
