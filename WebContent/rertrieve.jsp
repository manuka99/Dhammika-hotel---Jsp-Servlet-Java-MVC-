...
<table id = "tbl-food" class = "table table-bordered"  cellpadding = "0" cellspacing = "0" width="100%">
	...
	<script>
		$(document).ready(function() {
			...
			success:function(result){
				...
				var listProduct = $.parseJSON(result);
				var s = '';
				for (var i = 0; i < listProduct.length; i++) {
					
			        columns: [
			            {data: 'id', name: 'listProduct[i].itemID'},
			      
			        ]
					
					
					s += 'ID: ' + listProduct[i].itemID + listProduct[i].description + '<img src="data:image/jpg;base64,' + listProduct[i].image + '" width="50" height="50" /> ' + '<br>';
