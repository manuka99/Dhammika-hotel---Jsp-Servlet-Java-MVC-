...
/**
 * Servlet Filter implementation class PanelCommonAuthentication
 */
@WebFilter("/PanelCommonAuthentication")
public class PanelCommonAuthentication implements Filter {

	/**
	 * Default constructor.
	 */
	public PanelCommonAuthentication() {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (user != null && (userRolesNames.contains("admin") || userRolesNames.contains("food_manager")
				...
				|| userRolesNames.contains("customer_service_manager")))
